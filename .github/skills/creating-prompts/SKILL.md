...
description: Expert guidelines for creating effective and maintainable prompt files (.prompt.md) that guide GitHub Copilot in delivering consistent, high-quality outcomes.
---
...
Use this skill when:
- Creating new reusable prompt files (`.prompt.md`) for the project.
- Designing prompt inputs, workflows, and output expectations.
- Configuring prompt tools and permissions.
- Standardizing common tasks into prompts.
